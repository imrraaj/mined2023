    ...
    <Box marginBlock={16} id="partners">
      ...
      >
        <GridItem
          ...
          alignItems={"center"}
        >
          <Image src="https://images.unsplash.com/photo-1516876437184-593fda40c7ce?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8MTh8fGxvZ298ZW58MHx8MHx8&auto=format&fit=crop&w=500&q=60" />
        </GridItem>
        <GridItem
          borderWidth={"2px"}
          borderColor={"blue.400"}
